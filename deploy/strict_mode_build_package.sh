...
echo "Start Build for appsflyer-unity-plugin.unitypackage. Strict Mode."
 ...
 PACKAGE_NAME="appsflyer-unity-plugin-strict-mode-6.1.4.unitypackage"
 mkdir -p $DEPLOY_PATH
...
echo "Changing AppsFlyerFramework to Strict Mode. Done."
 ...
 -quit \
 && echo "package exported successfully to outputs/appsflyer-unity-plugin-strict-mode-6.1.4.unitypackage" \
