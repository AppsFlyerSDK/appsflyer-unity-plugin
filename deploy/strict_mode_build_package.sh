...
echo "Start Build for appsflyer-unity-plugin.unitypackage. Strict Mode."
 ...
 PACKAGE_NAME="appsflyer-unity-plugin-strict-mode-6.13.10.unitypackage"
 mkdir -p $DEPLOY_PATH
...
echo "Commenting out functions. Done."
 ...
 -quit \
 && echo "package exported successfully to outputs/appsflyer-unity-plugin-strict-mode-6.13.10.unitypackage" \
