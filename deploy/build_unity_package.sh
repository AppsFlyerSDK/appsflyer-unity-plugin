...
PACKAGE_NAME="appsflyer-unity-plugin-6.0.1-beta.unitypackage"
mkdir -p $DEPLOY_PATH
...
-quit \
&& echo "package exported successfully to outputs/appsflyer-unity-plugin-6.0.1-beta.unitypackage" \
