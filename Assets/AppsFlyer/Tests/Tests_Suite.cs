...
namespace AppsFlyerSDK.Tests
{
    public class NewTestScript
    {
        ...
        public void test_sendEvent_withValues()
        {
            ...
            AppsFlyerMOCKInterface.Received().sendEvent("testevent", eventParams, false, Arg.Any<string>());
        }
        ...
        public void test_sendEvent_withNullParams()
        {
            ...
            AppsFlyerMOCKInterface.Received().sendEvent("testevent", null, false, Arg.Any<string>());
        }
