...
-  Android & iOS API
    ...
    - [attributeAndOpenStore](#trackAndOpenStore)
    - [recordCrossPromoteImpression](#trackCrossPromoteImpression)
...
- [Android Only API](#androidOnly)
    ...
    - [setCustomerIdStartSDK](#setCustomerIdStartSDK)
...
| `gameObject` (optional) | `MonoBehaviour`             |             |
...
Once this API is invoked, the SDK will start.
...
| -----------      |-----------------------------|--------------|
| `eventName`        | `string`                      |              |
| `eventValues`      | `Dictionary<string, string>`  |              |
...
To restart SDK functions again once stopSDK is set to false, use the following SDK API:
...
**Note:** The ID must be set during the first launch of the app at the SDK initialization.
...
| parameter          | type                        | description  |
| -----------        |-----------------------------|--------------|
| `cryptMethod`      | `EmailCryptType`            |              |
| `emails`           | `params string[]`           |              |
...
##### <a id="trackAndOpenStore"> **`void attributeAndOpenStore(string appID, string campaign, Dictionary<string, string> userParams, MonoBehaviour gameObject)`**
...
##### <a id="trackCrossPromoteImpression"> **`void recordCrossPromoteImpression(string appID, string campaign);`**
...
---
 ...
 ##### <a id="setCustomerIdStartSDK"> **`void setCustomerIdStartSDK(string id)`**
...
| parameter           | type     | description  |
| -----------         |----------|--------------|
| `useReceiptValidationSandbox` | `bool`   |              |
