...
* As of 7.x, `disableAdvertisingIdentifier` and `waitForATTUserAuthorizationWithTimeoutInterval` were removed from the public API entirely (regular and strict alike) as part of the RPC bridge rewrite, so they're no longer strict-mode-specific.
